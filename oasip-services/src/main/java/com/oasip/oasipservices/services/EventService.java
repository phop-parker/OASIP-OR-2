...
public class EventService {
    ...
    public Event save(Event event) {
        checkDateTimeFuture(event.getEventStartTime(),event.getCategoryId().getEventCategoryName(),event.getCategoryId().getEventDuration());
    ...
    private void checkDateTimeFuture(LocalDateTime updateDateTime,String newEventCategoryName,Integer newEventDuration){
...
//            System.out.println("for loop process number"+i);
            ...
            LocalDateTime eventEndTime = findEndDate(eventList.get(i).getEventStartTime(),eventList.get(i).getEventDuration());
...
//            System.out.println("eventCategory.equalsIgnoreCase(newEventCategoryName) "+eventCategory.equalsIgnoreCase(newEventCategoryName));
...
//            System.out.println("time is overlapping");
                    throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Time is overlapping!! change date-time please");
        }
            }}
